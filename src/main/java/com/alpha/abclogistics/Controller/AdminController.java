...
public class AdminController {
	...
	@DeleteMapping("/deleteAddressBy/{id}")
	...
	public ResponseEntity<ResponseStructure<Driver>> updatedriver(@PathVariable int driverid,@PathVariable int carrierid,
	...
	@PutMapping("/updateorderbyid/{orderid}/assigncarrier/{truckid}")
	...
	public ResponseEntity<ResponseStructure<Order>> updateorderupdateloading(@PathVariable int orderid,
			@RequestBody LoadingDto ldto) {
		return orderService.updateorderupdateloading(orderid, ldto);
	}

	@PutMapping("/updateorder/{orderid}/updateUnloading")
	public ResponseEntity<ResponseStructure<Order>> updateorderupdatUnloading(@PathVariable int orderid,
			@RequestBody UnlaodingDto uldto) {
		return orderService.UpdateOrderUpdateUnloading(orderid, uldto);
	}

	@PutMapping("/updateorder/{orderid}/assigndriver/{driverid}")
	public ResponseEntity<ResponseStructure<Order>> assignDriverToOrder(@PathVariable int orderid,
